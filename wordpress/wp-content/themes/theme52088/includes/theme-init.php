...
if ( !function_exists( 'cherry_child_setup' ) ) :
	...
	function cherry_child_setup() {
		...
		add_image_size( 'slider-post-thumbnail', 1200, 844, true ); // Slider Thumbnail
...
/* Our Team */
/* Using a custom plugin for team info
