...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '16px', 'lineheight' => '24px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a2a2a'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#2a2a2a'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '28px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#232323'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '28px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#232323'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '22px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#32c182'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a2a2a'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2a2a2a'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '59px', 'lineheight' => '48px', 'face' => 'Six Caps', 'style' => 'normal', 'character'  => 'latin', 'color' => '#32c182'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#dcddd3'));
...
// ---------------------------------------------------------
			...
			$options['folio_button_text'] = array(
								...
								"std" => __('Learn more', CURRENT_THEME),
								);
